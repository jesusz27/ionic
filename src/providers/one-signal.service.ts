...
export class OneSignalService {
    ...
    constructor(private oneSignal: OneSignal, private alertCtrl: AlertController, private userService: UserService, private userStorageService:UserStorageService) {
